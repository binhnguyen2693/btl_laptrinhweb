...
<header class="figma-header"><div class="site-shell header-inner">
    ...
    <nav class="desktop-nav" id="primary-navigation" aria-label="Điều hướng chính">
        <a class="active" href="<?= e($basePath ?? '') ?>index.php">Trang chủ</a><a href="<?= e($basePath ?? '') ?>dang-phat-trien.php?feature=tin-khoa">Tin khoa</a><a href="<?= e($basePath ?? '') ?>dang-phat-trien.php?feature=hoc-tap">Học tập</a><a href="<?= e($basePath ?? '') ?>dang-phat-trien.php?feature=co-hoi">Cơ hội</a><a href="<?= e($basePath ?? '') ?>dang-phat-trien.php?feature=su-kien">Sự kiện</a><a href="<?= e($basePath ?? '') ?>dang-phat-trien.php?feature=huong-dan">Hướng dẫn</a><a href="<?= e($basePath ?? '') ?>dang-phat-trien.php?feature=impact-box">Hộp tác động</a>
    </nav>
