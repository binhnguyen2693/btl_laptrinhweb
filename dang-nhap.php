...
<?php if ($notice !== ''): ?><div class="message success"><?= e($notice) ?></div><?php endif; ?><?php if ($flashError !== ''): ?><div class="message error"><?= e($flashError) ?></div><?php endif; ?><?php if (isset($errors['login'])): ?><?php if ($accountLocked): ?><div class="account-locked-message" role="alert"><span class="account-locked-icon" aria-hidden="true"></span><span><strong>Tài khoản đã bị khóa</strong><small>Vui lòng liên hệ quản trị viên để được hỗ trợ mở khóa.</small></span></div><?php else: ?><div class="message error"><?= e($errors['login']) ?></div><?php endif; ?><?php endif; ?>
