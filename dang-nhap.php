...
<section class="auth-panel"><div class="figma-auth-card"><header><h2>NHỊP KHOA <span>The faculty post</span></h2><div class="faculty-mark"><i></i><span class="faculty-symbol"><img src="assets/images/figma/brand-logo.png" alt=""></span><i></i></div><h1>Đăng nhập</h1><p>Truy cập tài khoản Nhịp Khoa</p></header>
