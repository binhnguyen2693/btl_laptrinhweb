...
<section class="auth-panel"><div class="figma-auth-card register-card"><header><h2>NHỊP KHOA <span>The faculty post</span></h2><div class="faculty-mark"><i></i><span class="faculty-symbol"><img src="assets/images/figma/brand-logo.png" alt=""></span><i></i></div><h1>Đăng ký</h1><p>Đăng ký tài khoản thành viên Nhịp Khoa</p></header><?php if(isset($errors['register'])):?><div class="message error"><?= e($errors['register']) ?></div><?php endif;?>
