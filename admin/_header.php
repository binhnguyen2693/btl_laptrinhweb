...
<a class="<?= $adminPage === 'users' ? 'active' : '' ?>" href="/btl_laptrinhweb/admin/users.php"><span class="admin-nav-icon"><svg aria-hidden="true" viewBox="0 0 24 24"><circle cx="9" cy="8" r="3"/><path d="M3.5 19v-1.5A4.5 4.5 0 0 1 8 13h2a4.5 4.5 0 0 1 4.5 4.5V19"/><path d="M16 5.5a3 3 0 0 1 0 5.5M17 14a4 4 0 0 1 3.5 4v1"/></svg></span>Tài khoản</a>
<a href="../editor/posts.php"><span class="admin-nav-icon"><svg aria-hidden="true" viewBox="0 0 24 24"><path d="M6 3h9l4 4v14H6z"/><path d="M14 3v5h5M9 12h7M9 16h7"/></svg></span>Bài viết</a>
<a class="<?= $adminPage === 'categories' ? 'active' : '' ?>" href="/btl_laptrinhweb/views/categories.php">
...
<a class="<?= $adminPage === 'comments' ? 'active' : '' ?>" href="/btl_laptrinhweb/admin/binhluan.php">
    <span class="admin-nav-icon">
        <svg aria-hidden="true" viewBox="0 0 24 24">
