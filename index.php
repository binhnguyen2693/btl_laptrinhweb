...
<section id="topics" class="topic-section"><div class="site-shell topic-grid"><article><b>♧</b><div><h3>Học tập</h3><p>Lịch học, học phần, hướng dẫn học tập và tài liệu</p><a href="#">Khám phá →</a></div></article><article><b>▣</b><div><h3>Cơ hội</h3><p>Học bổng, tuyển dụng, thực tập và cuộc thi.</p><a href="#">Khám phá →</a></div></article><article><b>▤</b><div><h3>Sự kiện</h3><p>Hội thảo, workshop và hoạt động nổi bật.</p><a href="#">Khám phá →</a></div></article><article><b>◔</b><div><h3>Impact Box</h3><p>Dự án, sáng kiến và câu chuyện tác động.</p><a href="#">Khám phá →</a></div></article></div></section>
